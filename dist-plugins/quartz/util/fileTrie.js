...
class FileTrieNode {
    ...
    get slug() {
        const path = (0, path_1.joinSegments)(...this.slugSegments);
        if (this.isFolder) {
            return (0, path_1.joinSegments)(path, "index");
        }
        return path;
    }
    get slugSegment() {
    ...
    insert(path, file) {
        ...
        if (path.length === 1) {
            ...
            const child = this.children.find((c) => c.slugSegment === segment) ?? this.makeChild(path, undefined);
...
exports.FileTrieNode = FileTrieNode;
