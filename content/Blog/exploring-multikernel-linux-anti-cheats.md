...
I consider this post a direct follow-up to my last post about the the Linux desktop, ["2030 the year of desktop Linux"](/blog/2030-the-year-of-desktop-linux). In that post, I mentioned the issue of anti-cheat software, so I decided to explore this topic in more depth with this dedicated post. 

So, let's break down the technical disconnect between these environments and look at a structural, multikernel approach.
...
![Fragmented past stack](exploring-multikernel-linux-anti-cheats_1.svg)
...
![Fragmented past stack](exploring-multikernel-linux-anti-cheats_2.svg)
...
![Fragmented past stack](exploring-multikernel-linux-anti-cheats_4.svg)
...
#linux #tech #gaming #security #opensource #desktop
